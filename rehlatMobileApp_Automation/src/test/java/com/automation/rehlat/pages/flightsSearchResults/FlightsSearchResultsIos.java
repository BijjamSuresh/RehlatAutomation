...
public class FlightsSearchResultsIos extends FlightsSearchResultsBase {
    ...
    public static final String XPATH_OF_FLIGHT_SEARCH_RESULTS_CELL = "//XCUIElementTypeApplication[@name=\"Rehlat\"]/XCUIElementTypeWindow[1]/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther/XCUIElementTypeOther[1]/XCUIElementTypeTable/XCUIElementTypeCell[";
    ...
    public static void waitTillFlightsSearchResultsScreenIsDisplayed() {
        ...
        try{
            if (!isElementDisplayedByXPath(XPATH_OF_ALL_AIRLINES_TAB_BAR)){
    ...
    public void tapOnACellInFlightSearchResults(String flightSearchResultCellNumber) {
        ...
        String xPathOfBookingFlightCellType = XPATH_OF_FLIGHT_SEARCH_RESULTS_CELL+ flightSearchResultCellNumber + "]";
        try{
    ...
    public static String getTheBookingCostOfSelectingFlightInSearchResults(String selectedFlightCellTypeNumber) {
        ...
        String xPathOfBookingFlightCellType = XPATH_OF_FLIGHT_SEARCH_RESULTS_CELL+ selectedFlightCellTypeNumber + "]";
        try{
