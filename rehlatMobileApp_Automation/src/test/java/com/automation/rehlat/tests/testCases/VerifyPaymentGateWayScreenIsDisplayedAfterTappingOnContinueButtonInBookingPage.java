...
public class VerifyPaymentGateWayScreenIsDisplayedAfterTappingOnContinueButtonInBookingPage extends BaseTest {
    @Test
    public void testVerifyPaymentGateWayScreenIsDisplayedAfterTappingOnContinueButtonInBookingPage() throws Exception{
        Logger.beginTest("Verify payment gate way screen is displayed after tapping on continue button in booking page");
        ...
        Logger.endTest("Verify payment gate way screen is displayed after tapping on continue button in booking page");
    }
}
