...
public class TicketBooking_WithAppliedCouponCodeAndWithOutSignInOrSignUp_TwoWayBookings extends BaseTest {
    @Test
    public void testTicketBookingWithAppliedCouponCodeAndWithOutSignInOrSignUp() throws Exception{
