...
public class OneWayBooking_InternationalTicket_WithoutCouponCode_And_WithSignUp_FromBookingsPage extends BaseTest {
//    public static String  newEmailForSignUp = Labels.EMAIL_ID_SIGN_UP.replace("10","74");
    @Test
