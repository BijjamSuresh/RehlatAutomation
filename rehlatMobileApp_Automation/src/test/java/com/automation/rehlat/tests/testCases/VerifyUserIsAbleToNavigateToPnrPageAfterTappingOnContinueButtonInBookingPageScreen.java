...
public class VerifyUserIsAbleToNavigateToPnrPageAfterTappingOnContinueButtonInBookingPageScreen extends BaseTest {
    @Test
    public void testVerifyUserIsAbleToNavigateToPnrPageAfterTappingOnContinueButtonInBookingPageScreen() throws Exception{
        Logger.beginTest(" Verify user is able to navigate to pnr page after tapping on continue button in bookings page screen");
        ...
        Logger.endTest(" Verify user is able to navigate to pnr page after tapping on continue button in bookings page screen");
    }
}
